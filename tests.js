...
var arraysMatch_1 = require("./arraysMatch");
var emptyArr1 = [];
var emptyArr2 = [];
// Test 1: Make sure it recognizes that 2 empty arrays match:
if (arraysMatch_1.arraysMatch(emptyArr1, emptyArr2))
    console.log('test 1 passed');
else
    console.log('test 1 failed');
// Test 2: Make sure it recognizes that 1 empty array and 1 populated array don't match:
var populatedArray = [1];
if (arraysMatch_1.arraysMatch(emptyArr1, populatedArray))
    console.log('test 2 failed');
else
    console.log('test 2 passed');
// Test 3: Make sure it recognizes 2 arrays with same single item match:
populatedArray = [1];
var populatedArray2 = [1];
if (arraysMatch_1.arraysMatch(populatedArray, populatedArray2))
